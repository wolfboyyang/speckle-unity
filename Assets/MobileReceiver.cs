...
namespace Speckle.ConnectorUnity
{
  ...
  public class MobileReceiver : MonoBehaviour
  {
    ...
    public void Init(string streamId, bool autoReceive = false, bool deleteOld = true,
    ...
    private async void GetAndConvertObject(string objectId, string commitId)
    {
      try
      {
          var remoteTransport = new ServerTransport(Client.Account, StreamId);
          var localTransport = new RealmTransport();
